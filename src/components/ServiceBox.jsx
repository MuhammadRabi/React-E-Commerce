    ...
    <>
      {servicesData.map((item) => {
        return (
          <article
            key={item.id}
            className="flex flex-col max-w-xs p-4 py-8 mx-auto space-y-4 duration-300 ease-in bg-teal-600 rounded-md cursor-pointer text-slate-100 hover:bg-slate-100 hover:translate-y-2 hover:text-teal-600 justify-evenly box"
          >
            {item.icon}
