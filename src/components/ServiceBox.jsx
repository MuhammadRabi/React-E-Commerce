    ...
    <>
      {servicesData.map((item) => {
        return (
          <article
            key={item.id}
            className="flex flex-col p-4 py-8 space-y-4 duration-300 bg-teal-600 rounded-md cursor-pointer text-slate-100 hover:bg-slate-100 hover:text-teal-600 justify-evenly box"
          >
            {item.icon}
